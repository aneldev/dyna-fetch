...
exports.dynaFetch = function (url, axiosRequestConfig, dynaFetchParams_) {
  ...
  var getDelay = function () {
    return dynaFetchParams.retryRandomFactor === undefined ? dynaFetchParams.retryTimeout : dynaFetchParams.retryTimeout * (dyna_loops_1.random(0, dynaFetchParams.retryRandomFactor * 100) / 100);
  };
    ...
    var callFetch = function () {
      Promise.resolve().then(function () {
        return axios_1.default.request({
          ...
          method: "OPTIONS",
          headers: {
            "Access-Control-Request-Method": axiosRequestConfig.method || "GET",
